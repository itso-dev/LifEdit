<?php
    ...
    // 리스트에 출력하기 위한 sql문
    $admin_sql = "select * from partner_tbl order by id";
...
<form name="fmemberlist" id="fmemberlist" action="./setting/partner_delete.php" onsubmit="return fmemberlist_submit(this);" method="post">
    ...
    <div class="page-header">
        ...
        <div class="btn_fixed_top">
           <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_02">
            <a href="partner_form.php?menu=22&type=insert" id="member_add" class="btn btn_01">파트너 추가</a>
        </div>
    </div>
    <div class="card-body">
            ...
            <table class="table border-bottom" style="min-width: 800px;">
                <thead>
                    <tr>
                        ...
                        <th scope="col" id="mb_list_id" width="200px" colspan="2">이미지</th>
                        <th scope="col" id="mb_list_name" width="200px" class="text-center">기업 명</th>
                        <th scope="col" id="mb_list_join" width="250px" class="text-center">등록일</th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg0">
                            ...
                            <td headers="mb_list_id" colspan="2" class="td_name sv_use"><img class="list-thumb" src="<?= $root_url ?>/data/partner/<?= $list_row['chg_name'] ?>"></td>
                            ...
                            <td headers="mb_list_mng" class="td_mng td_mng_s text-center"><a href="partner_form.php?menu=22&type=modify&id=<?=$list_row['id']?>" class="btn btn_03">수정</a></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
