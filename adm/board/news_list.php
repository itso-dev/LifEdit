    ...
    <form name="fmemberlist" id="fmemberlist" action="./setting/board_delete.php" onsubmit="return fmemberlist_submit(this);" method="post">
        ...
        <div class="btn_fixed_top">
           <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_02">
            <a href="news_form.php?menu=44&type=insert" id="member_add" class="btn btn_01">게시글 추가</a>
        </div>
        <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr class="bg0">
                                ...
                                <td headers="mb_list_mng" class="td_mng td_mng_s text-center"><a href="news_form.php?menu=44&type=modify&id=<?=$list_row['id']?>" class="btn btn_03">수정</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
