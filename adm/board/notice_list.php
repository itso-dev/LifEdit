<?php
    ...
    // 리스트에 출력하기 위한 sql문
    $admin_sql = "select * from notice_tbl"
                .$stx_key
...
<link rel="stylesheet" type="text/css" href="<?= $site_url ?>/css/board_list.css" rel="stylesheet" />
    ...
    <div class="search-container">
        <form method="post">
            ...
            <input type="text" name="skey" placeholder="제목을 입력해주세요.">
            <input type="submit" value="검색"/>
        </form>
    </div>
    <form name="fmemberlist" id="fmemberlist" action="./setting/board_delete.php" onsubmit="return fmemberlist_submit(this);" method="post">
        <input type="hidden" name="type" value="notice"/>
        <div class="btn_fixed_top">
           <input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn btn_02">
            <a href="notice_form.php?menu=44&type=insert" id="member_add" class="btn btn_01">게시글 추가</a>
        </div>
        <div class="card-body">
                    ...
                    <thead>
                        ...
                        <tbody>
                            ...
                            <tr class="bg0">
                                ...
                                <td headers="mb_list_mng" class="td_mng td_mng_s text-center"><a href="notice_form.php?menu=44&type=modify&id=<?=$list_row['id']?>" class="btn btn_03">수정</a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                    </table>
