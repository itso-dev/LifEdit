...
// 리스트에 출력하기 위한 sql문
$admin_sql = "select * from contents2_tbl where id = 2";
...
<div class="page-header">
    <h4 class="page-title">프로젝트 관리 <span class="small">최종수정일: <?= $regdate ?></span></h4>
    <form name="logo_form" id="logo_form" method="post" action="./setting/contents_setting.php" enctype="multipart/form-data">
        ...
        <div class="input-wrap input-file">
            <p class="label-name">라이프에디트 랩 차별점 상세페이지 등록*</p>
        ...
        <div class="input-wrap input-file">
            <p class="label-name">프로젝트 분야 소개 등록*</p>
