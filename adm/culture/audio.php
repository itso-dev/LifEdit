...
// 리스트에 출력하기 위한 sql문
$admin_sql = "select * from contents_tbl where id = 2";
...
<div class="page-header">
    <h4 class="page-title">오디오 컨텐츠 사업 관리 <span class="small">최종수정일: <?= $regdate ?></span></h4>
    <form name="logo_form" id="logo_form" method="post" action="./setting/contents_setting.php" enctype="multipart/form-data">
        ...
        <div class="input-wrap input-file">
            <p class="label-name">오디오 컨텐츠 차별점 상세페이지 등록*</p>
        ...
        <div class="input-wrap input-file">
            <p class="label-name">오디오 컨텐츠 분야 소개 등록*</p>
        ...
        <p>오디오 컨텐츠 데이터</p>
        <div class="input-wrap">
            <p class="label-name">오디오 콘텐츠 수 (개)</p>
