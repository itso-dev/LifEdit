...
include_once($_SERVER["DOCUMENT_ROOT"].'/Lifedit/db/dbconfig.php');

$root_path = $_SERVER["DOCUMENT_ROOT"]."/Lifedit";
$site_path = $_SERVER["DOCUMENT_ROOT"]."/Lifedit/adm";
$root_url = "http://".$_SERVER["HTTP_HOST"]."/Lifedit";
$site_url = "http://".$_SERVER["HTTP_HOST"]."/Lifedit/adm";
